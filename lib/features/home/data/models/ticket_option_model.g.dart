...
part of 'ticket_option_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TicketOptionModel _$TicketOptionModelFromJson(Map<String, dynamic> json) =>
    TicketOptionModel(
...
Map<String, dynamic> _$TicketOptionModelToJson(TicketOptionModel instance) =>
    <String, dynamic>{
      'id': instance.id,
