...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( String message)?  error,TResult Function( List<SeatEntity> seats)?  data,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.message);case _Data() when data != null:
return data(_that.seats);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( String message)  error,required TResult Function( List<SeatEntity> seats)  data,}) {final _that = this;
switch (_that) {
case _Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( String message)?  error,TResult? Function( List<SeatEntity> seats)?  data,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.message);case _Data() when data != null:
...
class _Loading implements SeatSelectionState {
  const _Loading();
...
@override
String toString() {
  return 'SeatSelectionState.loading()';
}
...
class _Error implements SeatSelectionState {
...
@override
String toString() {
  return 'SeatSelectionState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $SeatSelectionStateCopyWith<$Res> {
...
class _Data implements SeatSelectionState {
  const _Data({required final  List<SeatEntity> seats}): _seats = seats;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Data&&const DeepCollectionEquality().equals(other._seats, _seats));
}
...
@override
String toString() {
  return 'SeatSelectionState.data(seats: $seats)';
}
...
/// @nodoc
abstract mixin class _$DataCopyWith<$Res> implements $SeatSelectionStateCopyWith<$Res> {
